...
import net.acetheeldritchking.cataclysm_spellbooks.entity.armor.ExcelsiusCooldownArmorModel;
import net.acetheeldritchking.cataclysm_spellbooks.items.armor.ExcelsiusCooldownArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class ExcelsiusCooldownArmorRenderer extends GeoArmorRenderer<ExcelsiusCooldownArmorItem> {
    public ExcelsiusCooldownArmorRenderer()
    {
        super(new ExcelsiusCooldownArmorModel());
