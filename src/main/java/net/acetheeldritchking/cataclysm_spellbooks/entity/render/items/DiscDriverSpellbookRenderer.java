...
import net.acetheeldritchking.cataclysm_spellbooks.items.spellbooks.animators.DiscDriverSpellbookAnimator;
    ...
    public DiscDriverSpellbookRenderer() {
        super(
                AzItemRendererConfig.builder(GEO, TEX)
                        ...
                        .setAnimatorProvider(DiscDriverSpellbookAnimator::new)
                        .build()
        );
    }
}
