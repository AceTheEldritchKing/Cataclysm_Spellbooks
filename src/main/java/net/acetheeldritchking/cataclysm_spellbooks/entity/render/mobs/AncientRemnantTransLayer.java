...
public class AncientRemnantTransLayer extends RenderLayer<Ancient_Remnant_Entity, Ancient_Remnant_Rework_Model> {
	private static final ResourceLocation LAYER_TEXTURES = ResourceLocation.fromNamespaceAndPath(Cataclysm.MODID,
			"textures/entity/ancient_remnant/ancient_remnant.png");
	...
	public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn,
			Ancient_Remnant_Entity entity, float limbSwing, float limbSwingAmount, float partialTicks,
		...
		(this.getParentModel()).renderToBuffer(matrixStackIn, VertexConsumer, packedLightIn,
				OverlayTexture.NO_OVERLAY, 0.5F, 0.7F, 0.9F, 0.4F);
	}
}
