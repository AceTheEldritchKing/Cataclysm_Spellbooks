...
public class ConjureKoboldiatorSpell extends AbstractSpell {
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        for (int i = 0; i < spellLevel; i++)
        {
            ...
            spawnKoboldiator(randomNearbyX, vec.y, randomNearbyZ, entity, level, summonTimer, castData);
        }

        super.onCast(level, spellLevel, entity, castSource, playerMagicData);
    }

    private void spawnKoboldiator(double x, double y, double z, LivingEntity caster, Level level, int summonTimer, SummonedEntitiesCastData castData)
    {
        ...
        SummonManager.initSummon(caster, kobolediator, summonTimer, castData);
    }
}
