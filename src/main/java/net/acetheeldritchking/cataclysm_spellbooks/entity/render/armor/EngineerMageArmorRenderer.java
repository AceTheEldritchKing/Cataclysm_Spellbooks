...
import net.acetheeldritchking.cataclysm_spellbooks.entity.armor.EngineerMageArmorModel;
...
public class EngineerMageArmorRenderer extends GeoArmorRenderer<EngineerMageArmorItem> {
    public EngineerMageArmorRenderer()
    {
        super(new EngineerMageArmorModel());
    }
