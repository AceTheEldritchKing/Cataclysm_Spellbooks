...
public class PhantomAncientRemnantRenderer extends Ancient_Remnant_Renderer {
	private static final ResourceLocation REMNANT_TEXTURES = ResourceLocation.fromNamespaceAndPath(
			CataclysmSpellbooks.MOD_ID, "textures/entity/ancient_remnant/ancient_remnant_rag.png");
