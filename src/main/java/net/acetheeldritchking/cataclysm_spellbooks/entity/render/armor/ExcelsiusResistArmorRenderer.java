...
import net.acetheeldritchking.cataclysm_spellbooks.entity.armor.ExcelsiusResistArmorModel;
import net.acetheeldritchking.cataclysm_spellbooks.items.armor.ExcelsiusResistArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class ExcelsiusResistArmorRenderer extends GeoArmorRenderer<ExcelsiusResistArmorItem> {
    public ExcelsiusResistArmorRenderer()
    {
        super(new ExcelsiusResistArmorModel());
