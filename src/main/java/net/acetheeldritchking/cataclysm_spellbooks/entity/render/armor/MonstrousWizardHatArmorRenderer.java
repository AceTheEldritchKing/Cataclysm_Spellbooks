...
import net.acetheeldritchking.cataclysm_spellbooks.entity.armor.MonstrousWizardHatArmorModel;
import net.acetheeldritchking.cataclysm_spellbooks.items.armor.MonstrousWizardHatArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class MonstrousWizardHatArmorRenderer extends GeoArmorRenderer<MonstrousWizardHatArmorItem> {
    public MonstrousWizardHatArmorRenderer() {
        super(new MonstrousWizardHatArmorModel());
    }
