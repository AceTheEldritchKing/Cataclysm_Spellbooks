...
import net.acetheeldritchking.cataclysm_spellbooks.entity.armor.ExcelsiusPowerArmorModel;
import net.acetheeldritchking.cataclysm_spellbooks.items.armor.ExcelsiusPowerArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class ExcelsiusPowerArmorRenderer extends GeoArmorRenderer<ExcelsiusPowerArmorItem> {
    public ExcelsiusPowerArmorRenderer()
    {
        super(new ExcelsiusPowerArmorModel());
